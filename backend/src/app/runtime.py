...
from src.tools import ToolManager, FilesystemTool, DateTimeTool, TerminalTool, SearchTool, GitTool, SystemInfoTool, WebTool, AppTool, ClipboardTool, ScreenshotTool, NotificationTool, MemoryTool, MediaTool, EmailTool, CalendarTool, RouterTool, CodeTool, PhoneTool, SystemControlTool, TimerTool, DocumentTool, SchedulerTool, WindowTool
...
class JarvisRuntime:
    def __init__(self, config_path="config.yaml"):
        ...
        if openrouter_key:
            ...
            tool_manager.register(DocumentTool())
            tool_manager.register(SchedulerTool())
            tool_manager.register(WindowTool())
